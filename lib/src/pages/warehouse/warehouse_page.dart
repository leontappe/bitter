...
import '/src/repositories/commissioning_repository.dart';
...
import '/src/widgets/item_selector.dart';
...
class _WarehousePageState extends State<WarehousePage> {
  ...
  late CommissioningRepository commissioningRepository;
            ...
            : TabBarView(
                children: [
                          ...
                          (Crate c) {
                            ...
                            return CrateListTile(
                              ...
                              trailing: PopupMenuButton(
                                tooltip: 'Menü zeigen',
                                onSelected: (CratePopupSelection input) =>
                                    onSelected(input, c),
                  ...
                  RefreshIndicator(
                    ...
                    child: ListView(
                      children: [
                        ...commissionings.reversed
                            .map<Widget>((Commissioning c) => ListTile(
                                  title: Text(
                                      'Kommissionierung vom ${formatDateTime(c.timestamp!)}'),
  ...
  Future<void> initDb() async {
    ...
    commissioningRepository =
        CommissioningRepository(InheritedDatabase.of(context));
  ...
  Future<void> onRefresh() async {
    ...
    commissionings =
        await commissioningRepository.select(warehousesFilter: widget.id);
  ...
  void _onCreateCommissioning() {
    Navigator.of(context).push<dynamic>(MaterialPageRoute<dynamic>(
        builder: (BuildContext context) =>
            CommissioningCreatorPage(warehouse: warehouse!)));
  }
    ...
    final dialogResult = await showDialog<Crate>(
        ...
        builder: (BuildContext context) {
          ...
          var sizeController = TextEditingController(
              text: result.size > 0 ? result.size.toString() : 'Unbegrenzt');
          return OptionDialog(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    labelText: 'Kapazität', suffixText: 'Einheiten'),
    ...
    await showDialog<bool>(
      ...
      builder: (BuildContext context) => SimpleDialog(
        ...
        children: [
          ...
          ListTile(
              title: Text('Lagerplatz:'),
              trailing: Text(warehouse!.name ?? '')),
